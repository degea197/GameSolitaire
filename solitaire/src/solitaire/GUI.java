...
public class GUI extends JFrame implements ActionListener, MouseListener,
    ...
    public GUI(Engine game, SocketClient client, String userName) {
        this.game = game;
        this.client = client;
        this.userName = userName;
        // Initialize stuff
    ...
    public GUI(Engine game, SocketClient client, String userName, String userName1) {
        this.game = game;
        this.client = client;
        this.userName = userName;
        this.userName1 = userName1;
...
//                JOptionPane.showMessageDialog(this, "You won! Congrats!");
                ...
                client.send(new Message("winner", userName, userName1, "SERVER"));
                if (JOptionPane.showConfirmDialog(null, "ban da chien thang. chơi tiếp nha") == 0) {
                    reset();
                }
                else{
                    System.exit(0);
